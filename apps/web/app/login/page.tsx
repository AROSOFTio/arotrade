  ...
  return (
    <main className="flex min-h-screen bg-[#f6f7f9] px-4 py-8 sm:items-center sm:justify-center">
      <section className="mx-auto w-full max-w-md">
        <Link href="/" className="mb-8 inline-flex items-center gap-3"><img src="/logo.png" alt="AroTrader logo" className="h-10 w-10" /><span><span className="block text-base font-bold text-slate-950">AroTrader</span><span className="block text-xs font-medium text-slate-500">by AROFi</span></span></Link>
